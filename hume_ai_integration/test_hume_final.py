#!/usr/bin/env python3
"""
Test Hume AI SDK - Final Version

This script tests the official Hume AI SDK with the correct method names.
"""
...
def test_hume_client():
    ...
    try:
        ...
        print(f"📊 Available methods: {[m for m in dir(tts) if not m.startswith('_')]}")
        
        # Test voice generation using synthesize_json
        text = "Hello, this is a test of Hume AI voice generation."
        print(f"📝 Text: {text}")
        
        print("🔄 Generating speech...")
        response = tts.synthesize_json(text=text)
...
def test_empathic_voice():
    ...
    try:
        ...
        print(f"📊 Available methods: {[m for m in dir(evi) if not m.startswith('_')]}")
        print("✅ EVI initialized!")
        
        # Test voice generation with emotion using chat
        text = "I am feeling very happy today!"
        print(f"📝 Text: {text}")
        
        print("🔄 Generating empathic voice...")
        # Use the chat method for empathic voice
        response = evi.chat(text=text)
...
if __name__ == "__main__":
    print("🧪 Hume AI SDK Testing (Final Version)")
    print("=" * 60)
